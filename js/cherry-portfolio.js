angular.module('cherry-portfolio', [])
	.controller('AccomplishmentsController', function() {
		...
		accomplishments.list = [
			...
			{img: 'images\\froggerGame.png', text: 'FroggerArcadeGame', link: 'http://rawgit.com/mttchrry/frontend-nanodegree-arcade-game/master/index.html', summary: 'A neat simple little frogger game, using some standard inputs and drawing/layering.'},
